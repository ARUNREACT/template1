  ...
  return (
    <div className="about-us">
      ...
      <div className="col-lg-10 mx-auto mainpagehead">
        ...
        <p>
          Thus began the journey of Eko. Abhinav and Abhishek believed in the
          ...
          for Eko. What followed was a string of inventions, patented all over
        ...
        <p>
          Eko leveraged every progressive technology available to build
        ...
        <p>
          ...
          Eko has built over 100 services on its platform to cater to all needs
          a customer has from a bank, and even offered open APIs to truly
          democratise them.
        </p>
        <p>
          Eko has served over 50 Million customers till date, is available over
          a merchant network of 1,50,000 customers and enables over 7 Million
          banking transactions a month. This it does, via its own network and by
          providing APIs to over 300 partners who have built their own business
          on top of the Eko platform.
        </p>
        <p>
          Eko is committed to ever expanding its range of financial services
        ...
        <p>
          As a truly inclusive organisation, Eko constantly seeks partnerships
          ...
          Eko welcomes merchants, developers, brands and service providers to
